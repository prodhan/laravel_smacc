...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.sliderlist', compact('allData'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($bug==0){
          return redirect('/slider')->with('success', 'Your Slider has been saved!');  
        }
        else
        {
            return redirect('/slider')->with('error', 'Something went wrong!');
        }
